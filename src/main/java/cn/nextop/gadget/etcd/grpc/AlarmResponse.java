 ...
 */
@SuppressWarnings("all") public final class AlarmResponse extends
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              alarms_ = new java.util.ArrayList<cn.nextop.gadget.etcd.grpc.AlarmMember>();
              mutable_bitField0_ |= 0x00000002;
            }
            alarms_.add(
                input.readMessage(cn.nextop.gadget.etcd.grpc.AlarmMember.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cn.nextop.gadget.etcd.grpc.JetcdProto.internal_static_etcdserverpb_AlarmResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return cn.nextop.gadget.etcd.grpc.JetcdProto.internal_static_etcdserverpb_AlarmResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cn.nextop.gadget.etcd.grpc.AlarmResponse.class, cn.nextop.gadget.etcd.grpc.AlarmResponse.Builder.class);
  }
  ...
  private java.util.List<cn.nextop.gadget.etcd.grpc.AlarmMember> alarms_;
  /**
   * <pre>
   ...
   */
  public java.util.List<cn.nextop.gadget.etcd.grpc.AlarmMember> getAlarmsList() {
    return alarms_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public java.util.List<? extends cn.nextop.gadget.etcd.grpc.AlarmMemberOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public cn.nextop.gadget.etcd.grpc.AlarmMember getAlarms(int index) {
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public cn.nextop.gadget.etcd.grpc.AlarmMemberOrBuilder getAlarmsOrBuilder(
      int index) {
    return alarms_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cn.nextop.gadget.etcd.grpc.AlarmResponse)) {
      return super.equals(obj);
    }
    cn.nextop.gadget.etcd.grpc.AlarmResponse other = (cn.nextop.gadget.etcd.grpc.AlarmResponse) obj;
  ...
  public static cn.nextop.gadget.etcd.grpc.AlarmResponse parseFrom(
  ...
  public static cn.nextop.gadget.etcd.grpc.AlarmResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cn.nextop.gadget.etcd.grpc.AlarmResponse parseFrom(
  ...
  public static cn.nextop.gadget.etcd.grpc.AlarmResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cn.nextop.gadget.etcd.grpc.AlarmResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static cn.nextop.gadget.etcd.grpc.AlarmResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cn.nextop.gadget.etcd.grpc.AlarmResponse prototype) {
  ...
  public static final class Builder extends
      ...
      cn.nextop.gadget.etcd.grpc.AlarmResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cn.nextop.gadget.etcd.grpc.JetcdProto.internal_static_etcdserverpb_AlarmResponse_descriptor;
    }
    ...
    // Construct using cn.nextop.gadget.etcd.grpc.AlarmResponse.newBuilder()
    private Builder() {
    ...
    public cn.nextop.gadget.etcd.grpc.AlarmResponse getDefaultInstanceForType() {
      return cn.nextop.gadget.etcd.grpc.AlarmResponse.getDefaultInstance();
    }

    public cn.nextop.gadget.etcd.grpc.AlarmResponse build() {
      cn.nextop.gadget.etcd.grpc.AlarmResponse result = buildPartial();
    ...
    public cn.nextop.gadget.etcd.grpc.AlarmResponse buildPartial() {
      cn.nextop.gadget.etcd.grpc.AlarmResponse result = new cn.nextop.gadget.etcd.grpc.AlarmResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cn.nextop.gadget.etcd.grpc.AlarmResponse) {
        return mergeFrom((cn.nextop.gadget.etcd.grpc.AlarmResponse)other);
      } else {
    ...
    public Builder mergeFrom(cn.nextop.gadget.etcd.grpc.AlarmResponse other) {
      if (other == cn.nextop.gadget.etcd.grpc.AlarmResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      cn.nextop.gadget.etcd.grpc.AlarmResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (cn.nextop.gadget.etcd.grpc.AlarmResponse) e.getUnfinishedMessage();
    ...
    private void ensureAlarmsIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        alarms_ = new java.util.ArrayList<cn.nextop.gadget.etcd.grpc.AlarmMember>(alarms_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cn.nextop.gadget.etcd.grpc.AlarmMember, cn.nextop.gadget.etcd.grpc.AlarmMember.Builder, cn.nextop.gadget.etcd.grpc.AlarmMemberOrBuilder> alarmsBuilder_;
    ...
    public Builder setAlarms(
        int index, cn.nextop.gadget.etcd.grpc.AlarmMember value) {
      if (alarmsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setAlarms(
        int index, cn.nextop.gadget.etcd.grpc.AlarmMember.Builder builderForValue) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public Builder addAlarms(cn.nextop.gadget.etcd.grpc.AlarmMember value) {
      if (alarmsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addAlarms(
        cn.nextop.gadget.etcd.grpc.AlarmMember.Builder builderForValue) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
    ...
    public Builder addAllAlarms(
        java.lang.Iterable<? extends cn.nextop.gadget.etcd.grpc.AlarmMember> values) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public cn.nextop.gadget.etcd.grpc.AlarmMember.Builder getAlarmsBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public cn.nextop.gadget.etcd.grpc.AlarmMember.Builder addAlarmsBuilder() {
      return getAlarmsFieldBuilder().addBuilder(
          cn.nextop.gadget.etcd.grpc.AlarmMember.getDefaultInstance());
    }
    /**
     * <pre>
     * alarms is a list of alarms associated with the alarm request.
    ...
    public cn.nextop.gadget.etcd.grpc.AlarmMember.Builder addAlarmsBuilder(
        int index) {
      return getAlarmsFieldBuilder().addBuilder(
          index, cn.nextop.gadget.etcd.grpc.AlarmMember.getDefaultInstance());
    }
    /**
     * <pre>
     * alarms is a list of alarms associated with the alarm request.
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public java.util.List<cn.nextop.gadget.etcd.grpc.AlarmMember.Builder> 
         getAlarmsBuilderList() {
      return getAlarmsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cn.nextop.gadget.etcd.grpc.AlarmMember, cn.nextop.gadget.etcd.grpc.AlarmMember.Builder, cn.nextop.gadget.etcd.grpc.AlarmMemberOrBuilder> 
        getAlarmsFieldBuilder() {
      if (alarmsBuilder_ == null) {
  ...
  private static final cn.nextop.gadget.etcd.grpc.AlarmResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cn.nextop.gadget.etcd.grpc.AlarmResponse();
  }

  public static cn.nextop.gadget.etcd.grpc.AlarmResponse getDefaultInstance() {
