...
public interface WatchResponseOrBuilder extends
   ...
   */
  java.util.List<cn.nextop.gadget.etcd.grpc.Event> 
      getEventsList();
  /**
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  cn.nextop.gadget.etcd.grpc.Event getEvents(int index);
  /**
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  int getEventsCount();
   ...
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  java.util.List<? extends cn.nextop.gadget.etcd.grpc.EventOrBuilder> 
      getEventsOrBuilderList();
  /**
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  cn.nextop.gadget.etcd.grpc.EventOrBuilder getEventsOrBuilder(
      int index);
}
