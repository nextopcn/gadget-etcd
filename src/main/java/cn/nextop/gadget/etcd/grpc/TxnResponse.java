 ...
 */
@SuppressWarnings("all") public final class TxnResponse extends
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              responses_ = new java.util.ArrayList<cn.nextop.gadget.etcd.grpc.ResponseOp>();
              mutable_bitField0_ |= 0x00000004;
            }
            responses_.add(
                input.readMessage(cn.nextop.gadget.etcd.grpc.ResponseOp.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cn.nextop.gadget.etcd.grpc.JetcdProto.internal_static_etcdserverpb_TxnResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return cn.nextop.gadget.etcd.grpc.JetcdProto.internal_static_etcdserverpb_TxnResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cn.nextop.gadget.etcd.grpc.TxnResponse.class, cn.nextop.gadget.etcd.grpc.TxnResponse.Builder.class);
  }
  ...
  private java.util.List<cn.nextop.gadget.etcd.grpc.ResponseOp> responses_;
  /**
   * <pre>
   ...
   */
  public java.util.List<cn.nextop.gadget.etcd.grpc.ResponseOp> getResponsesList() {
    return responses_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  public java.util.List<? extends cn.nextop.gadget.etcd.grpc.ResponseOpOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  public cn.nextop.gadget.etcd.grpc.ResponseOp getResponses(int index) {
   ...
   * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
   */
  public cn.nextop.gadget.etcd.grpc.ResponseOpOrBuilder getResponsesOrBuilder(
      int index) {
    return responses_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cn.nextop.gadget.etcd.grpc.TxnResponse)) {
      return super.equals(obj);
    }
    cn.nextop.gadget.etcd.grpc.TxnResponse other = (cn.nextop.gadget.etcd.grpc.TxnResponse) obj;
  ...
  public static cn.nextop.gadget.etcd.grpc.TxnResponse parseFrom(
  ...
  public static cn.nextop.gadget.etcd.grpc.TxnResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cn.nextop.gadget.etcd.grpc.TxnResponse parseFrom(
  ...
  public static cn.nextop.gadget.etcd.grpc.TxnResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cn.nextop.gadget.etcd.grpc.TxnResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static cn.nextop.gadget.etcd.grpc.TxnResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cn.nextop.gadget.etcd.grpc.TxnResponse prototype) {
  ...
  public static final class Builder extends
      ...
      cn.nextop.gadget.etcd.grpc.TxnResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cn.nextop.gadget.etcd.grpc.JetcdProto.internal_static_etcdserverpb_TxnResponse_descriptor;
    }
    ...
    // Construct using cn.nextop.gadget.etcd.grpc.TxnResponse.newBuilder()
    private Builder() {
    ...
    public cn.nextop.gadget.etcd.grpc.TxnResponse getDefaultInstanceForType() {
      return cn.nextop.gadget.etcd.grpc.TxnResponse.getDefaultInstance();
    }

    public cn.nextop.gadget.etcd.grpc.TxnResponse build() {
      cn.nextop.gadget.etcd.grpc.TxnResponse result = buildPartial();
    ...
    public cn.nextop.gadget.etcd.grpc.TxnResponse buildPartial() {
      cn.nextop.gadget.etcd.grpc.TxnResponse result = new cn.nextop.gadget.etcd.grpc.TxnResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cn.nextop.gadget.etcd.grpc.TxnResponse) {
        return mergeFrom((cn.nextop.gadget.etcd.grpc.TxnResponse)other);
      } else {
    ...
    public Builder mergeFrom(cn.nextop.gadget.etcd.grpc.TxnResponse other) {
      if (other == cn.nextop.gadget.etcd.grpc.TxnResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      cn.nextop.gadget.etcd.grpc.TxnResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (cn.nextop.gadget.etcd.grpc.TxnResponse) e.getUnfinishedMessage();
    ...
    private void ensureResponsesIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        responses_ = new java.util.ArrayList<cn.nextop.gadget.etcd.grpc.ResponseOp>(responses_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cn.nextop.gadget.etcd.grpc.ResponseOp, cn.nextop.gadget.etcd.grpc.ResponseOp.Builder, cn.nextop.gadget.etcd.grpc.ResponseOpOrBuilder> responsesBuilder_;
    ...
    public Builder setResponses(
        int index, cn.nextop.gadget.etcd.grpc.ResponseOp value) {
      if (responsesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setResponses(
        int index, cn.nextop.gadget.etcd.grpc.ResponseOp.Builder builderForValue) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public Builder addResponses(cn.nextop.gadget.etcd.grpc.ResponseOp value) {
      if (responsesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addResponses(
        cn.nextop.gadget.etcd.grpc.ResponseOp.Builder builderForValue) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
    ...
    public Builder addAllResponses(
        java.lang.Iterable<? extends cn.nextop.gadget.etcd.grpc.ResponseOp> values) {
      if (responsesBuilder_ == null) {
        ensureResponsesIsMutable();
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public cn.nextop.gadget.etcd.grpc.ResponseOp.Builder getResponsesBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public cn.nextop.gadget.etcd.grpc.ResponseOp.Builder addResponsesBuilder() {
      return getResponsesFieldBuilder().addBuilder(
          cn.nextop.gadget.etcd.grpc.ResponseOp.getDefaultInstance());
    }
    /**
     * <pre>
     * responses is a list of responses corresponding to the results from applying
    ...
    public cn.nextop.gadget.etcd.grpc.ResponseOp.Builder addResponsesBuilder(
        int index) {
      return getResponsesFieldBuilder().addBuilder(
          index, cn.nextop.gadget.etcd.grpc.ResponseOp.getDefaultInstance());
    }
    /**
     * <pre>
     * responses is a list of responses corresponding to the results from applying
     ...
     * <code>repeated .etcdserverpb.ResponseOp responses = 3;</code>
     */
    public java.util.List<cn.nextop.gadget.etcd.grpc.ResponseOp.Builder> 
         getResponsesBuilderList() {
      return getResponsesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cn.nextop.gadget.etcd.grpc.ResponseOp, cn.nextop.gadget.etcd.grpc.ResponseOp.Builder, cn.nextop.gadget.etcd.grpc.ResponseOpOrBuilder> 
        getResponsesFieldBuilder() {
      if (responsesBuilder_ == null) {
  ...
  private static final cn.nextop.gadget.etcd.grpc.TxnResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cn.nextop.gadget.etcd.grpc.TxnResponse();
  }

  public static cn.nextop.gadget.etcd.grpc.TxnResponse getDefaultInstance() {
